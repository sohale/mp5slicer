...
# def intersect_layers_as_island_stack( down_islands,this_island, up_islands):
#     upskins = []
#     downskins= []
#     # if len(botLay) == 0:
...
#     # if len(topLay) == 0:
#     #     return downskins,upskins
#     thisLay = this_island.get_innershells()
#
#
#
#     for up_island in up_islands:
#         topLay = up_island.get_inneshells()
#         temp_upskins = []
#
#
#
