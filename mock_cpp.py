...
def print_from_pipe():
    ...
    # double mushroom
    # mp5 = '{"printerSettings":{"name":"test","layerThickness":0.2,"emptyLayer":0,"infillSpace":4,"topThickness":0.6,"paramSamples":75,"speedRate":1000,"circleSpeedRate":1000,"temperature":220,"inAirSpeed":7000,"flowRate":0.035,"criticalLength":35,"retractionSpeed":2400,"retractionLength":5,"shellNumber":3,"material":"PLA 2.85mm","autoZScar":true,"zScarGap":0.5,"critLayerTime":6,"filamentDiameter":2.85},"mp5-version":"0.3","root":{"type":"root","children":[{"type":"implicit_double_mushroom","displayColor":{"x":6,"y":0.7,"z":0.7},"matrix":[10,0,0,84.55341967686932,0,10,0,121.11403382006986,0,0,10,5,0,0,0,1],"index":2375196}]}}'
    # cube
    mp5 = '''{"printerSettings":{"name":"test","layerThickness":0.2,"emptyLayer":0,"infillSpace":4,"topThickness":0.6,"paramSamples":75,"speedRate":1000,"circleSpeedRate":1000,"temperature":220,"inAirSpeed":7000,"flowRate":0.035,"criticalLength":35,"retractionSpeed":2400,"retractionLength":5,"shellNumber":3,"material":"PLA 2.85mm","autoZScar":true,"zScarGap":0.5,"critLayerTime":6,"filamentDiameter":2.85},"mp5-version":"0.3","root":{"type":"root","children":[{"type":"icube","displayColor":{"x":0.7,"y":0.7,"z":7},
              "matrix":[10,0,0,0,
                        0,10,0,0,
                        0,0,10,0,
                        0,0,0,1],
    ...
    # ellisoid
    # mp5 = '{"mp5-version":"0.3","root":{"type":"root","children":[{"type":"iellipsoid", "matrix":[10,0,0,0, 0,10,0,0, 0,0,10,0, 0,0,0,1],"index":5498993}]}}'
...
def to_json_mc_params(bbox):
    ...
    mc_params = {"resolution": 10, "box": bb, "ignore_root_matrix": ignore_root_matrix}
