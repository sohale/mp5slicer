...
#!!!!!!!DO NOT REMOVE CODE (or do if you have red the following): This code uses sorted list of ordered distances,
#it can be used to improve the gridy closest point search, if you don't care, feel free to remove.
